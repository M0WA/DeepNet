...
const TableColumn* __TMPL_TABLE_NAME__TableBase::GetConstColumn___TMPL_FIELD_NAME__() const {
...
TableColumn* __TMPL_TABLE_NAME__TableBase::GetColumn___TMPL_FIELD_NAME__() {
