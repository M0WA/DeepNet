...
/* queryresultthread - MySQL */
CREATE TABLE IF NOT EXISTS  queryserver.queryresultthread (ID INTEGER);
DROP TABLE queryserver.queryresultthread;
CREATE TABLE queryserver.queryresultthread
(
 ID INTEGER AUTO_INCREMENT NOT NULL,
...
/* queryproperties - MySQL */
CREATE TABLE IF NOT EXISTS  queryserver.queryproperties (ID INTEGER);
DROP TABLE queryserver.queryproperties;
CREATE TABLE queryserver.queryproperties
(
 ID INTEGER AUTO_INCREMENT NOT NULL,
 ...
 relContent DOUBLE NOT NULL,
 relMeta DOUBLE NOT NULL,
 relSecondLevel DOUBLE NOT NULL,
 relSubdomain DOUBLE NOT NULL,
 relUrlPath DOUBLE NOT NULL,
...
(
 ...
 INDEX IDX__searchquery_IDENTIFIER (identifier),
 INDEX IDX__searchquery_SESSION (session),
 INDEX IDX__searchquery_MODIFIED (modified),
 INDEX IDX__searchquery_FINISHED (finished)
) Engine=InnoDB, ROW_FORMAT=COMPACT;
SHOW WARNINGS;
...
ALTER TABLE queryserver.queryresults ADD CONSTRAINT FK__QUERYRESULTS_URLSTAGE_ID FOREIGN KEY (URLSTAGE_ID) REFERENCES contents.urlstages (ID);

ALTER TABLE queryserver.queryresults ADD CONSTRAINT FK__QUERYRESULTS_URL_ID FOREIGN KEY (URL_ID) REFERENCES documents.urls (ID);
...
ALTER TABLE queryserver.queryproperties ADD CONSTRAINT FK__QUERYPROPERTIES_SECONDLEVELDOMAIN_ID FOREIGN KEY (SECONDLEVELDOMAIN_ID) REFERENCES documents.secondleveldomains (ID);

ALTER TABLE queryserver.queryproperties ADD CONSTRAINT FK__QUERYPROPERTIES_SUBDOMAIN_ID FOREIGN KEY (SUBDOMAIN_ID) REFERENCES documents.subdomains (ID);
...
ALTER TABLE queryserver.searchquery ADD CONSTRAINT FK__SEARCHQUERY_RESULTTHREAD_ID FOREIGN KEY (RESULTTHREAD_ID) REFERENCES queryserver.queryresultthread (ID);

ALTER TABLE queryserver.searchquery ADD CONSTRAINT FK__SEARCHQUERY_PROPERTIES_ID FOREIGN KEY (PROPERTIES_ID) REFERENCES queryserver.queryproperties (ID);
