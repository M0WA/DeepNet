...
/* searchqueryresultinfo - MySQL */
CREATE TABLE IF NOT EXISTS  queryserver.searchqueryresultinfo (ID INTEGER);
DROP TABLE queryserver.searchqueryresultinfo;
CREATE TABLE queryserver.searchqueryresultinfo
(
 ID INTEGER AUTO_INCREMENT NOT NULL,
 SEARCHQUERYRESULT_ID INTEGER NOT NULL,
 infotype INTEGER NOT NULL,
 type VARCHAR(255) NOT NULL,
 CONSTRAINT PRI__SEARCHQUERYRESULTINFO_ID PRIMARY KEY (ID),
 INDEX IDX__searchqueryresultinfo_INFOTYPE (infotype ASC)
) Engine=InnoDB, ROW_FORMAT=COMPACT;
SHOW WARNINGS;
...
(
 ...
 isKeywordRegex INTEGER NOT NULL DEFAULT 0,
...
/* unittest3 - MySQL */
CREATE TABLE IF NOT EXISTS  logging.unittest3 (ID INTEGER);
DROP TABLE logging.unittest3;
CREATE TABLE logging.unittest3
(
 ID INTEGER AUTO_INCREMENT NOT NULL,
...
(
 ...
 response_code INTEGER DEFAULT -1,
 content_md5 CHAR(32) DEFAULT NULL,
 last_change TIMESTAMP DEFAULT '1970-01-01 00:00:01',
 redirect_count INTEGER DEFAULT NULL,
 download_speed BIGINT DEFAULT NULL,
 upload_speed BIGINT DEFAULT NULL,
 content_length BIGINT DEFAULT NULL,
 content_type VARCHAR(255) DEFAULT NULL,
 primary_ip BIGINT DEFAULT NULL,
 primary_port INTEGER DEFAULT NULL,
 int_links INTEGER DEFAULT NULL,
 ext_links INTEGER DEFAULT NULL,
 download_time INTEGER DEFAULT NULL,
 html_errors INTEGER DEFAULT NULL,
...
(
 ...
 resultXML TEXT(1024000) NOT NULL,
 position INTEGER NOT NULL,
 CONSTRAINT PRI__QUERYRESULTS_ID PRIMARY KEY (ID),
 INDEX IDX__queryresults_POSITION (position ASC)
) Engine=InnoDB, ROW_FORMAT=COMPACT;
SHOW WARNINGS;
...
(
 ...
 revisitInterval INTEGER NOT NULL DEFAULT 120,
 isDomainRegex INTEGER NOT NULL DEFAULT 0,
...
/* urlpathparts - MySQL */
CREATE TABLE IF NOT EXISTS  documents.urlpathparts (ID INTEGER);
DROP TABLE documents.urlpathparts;
CREATE TABLE documents.urlpathparts
(
 ID INTEGER AUTO_INCREMENT NOT NULL,
...
(
 ...
 threadName VARCHAR(255) DEFAULT '',
...
/* urlsearchparts - MySQL */
CREATE TABLE IF NOT EXISTS  documents.urlsearchparts (ID INTEGER);
DROP TABLE documents.urlsearchparts;
CREATE TABLE documents.urlsearchparts
(
 ID INTEGER AUTO_INCREMENT NOT NULL,
...
/* pathparts - MySQL */
CREATE TABLE IF NOT EXISTS  documents.pathparts (ID INTEGER);
DROP TABLE documents.pathparts;
CREATE TABLE documents.pathparts
(
 ID INTEGER AUTO_INCREMENT NOT NULL,
...
/* urlspathpart - MySQL */
CREATE TABLE IF NOT EXISTS  documents.urlspathpart (ID INTEGER);
DROP TABLE documents.urlspathpart;
CREATE TABLE documents.urlspathpart
(
 ID INTEGER AUTO_INCREMENT NOT NULL,
 PATHPART_ID INTEGER NOT NULL,
 URL_ID INTEGER NOT NULL,
...
(
 ...
 isPathRegex INTEGER NOT NULL DEFAULT 0,
...
(
 SECONDLEVELDOMAIN_ID INTEGER NOT NULL,
 CRAWLERSESSION_ID INTEGER NOT NULL DEFAULT 0,
 schedule TIMESTAMP NOT NULL,
...
/* searchqueryresult - MySQL */
CREATE TABLE IF NOT EXISTS  queryserver.searchqueryresult (ID INTEGER);
DROP TABLE queryserver.searchqueryresult;
CREATE TABLE queryserver.searchqueryresult
(
 ID INTEGER AUTO_INCREMENT NOT NULL,
 SEARCHQUERY_ID INTEGER NOT NULL,
 URL_ID INTEGER NOT NULL,
 position INTEGER NOT NULL,
 CONSTRAINT PRI__SEARCHQUERYRESULT_ID PRIMARY KEY (ID),
 INDEX IDX__searchqueryresult_POSITION (position ASC)
) Engine=InnoDB, ROW_FORMAT=COMPACT;
SHOW WARNINGS;
...
ALTER TABLE queryserver.searchqueryresultinfo ADD CONSTRAINT FK__SEARCHQUERYRESULTINFO_SEARCHQUERYRESULT_ID FOREIGN KEY (SEARCHQUERYRESULT_ID) REFERENCES queryserver.searchqueryresult (ID);
...
ALTER TABLE documents.images ADD CONSTRAINT FK__IMAGES_URLPATHPART_ID FOREIGN KEY (URLPATHPART_ID) REFERENCES documents.urlpathparts (ID);

ALTER TABLE documents.images ADD CONSTRAINT FK__IMAGES_URLSEARCHPART_ID FOREIGN KEY (URLSEARCHPART_ID) REFERENCES documents.urlsearchparts (ID);
...
ALTER TABLE documents.urls ADD CONSTRAINT FK__URLS_URLPATHPART_ID FOREIGN KEY (URLPATHPART_ID) REFERENCES documents.urlpathparts (ID);

ALTER TABLE documents.urls ADD CONSTRAINT FK__URLS_URLSEARCHPART_ID FOREIGN KEY (URLSEARCHPART_ID) REFERENCES documents.urlsearchparts (ID);

ALTER TABLE logging.unittest3 ADD CONSTRAINT FK__UNITTEST3_UNITTEST1_ID FOREIGN KEY (UNITTEST1_ID) REFERENCES logging.unittest1 (ID);

ALTER TABLE logging.unittest3 ADD CONSTRAINT FK__UNITTEST3_UNITTEST2_ID FOREIGN KEY (UNITTEST2_ID) REFERENCES logging.unittest2 (ID);
...
ALTER TABLE documents.urlpathparts ADD CONSTRAINT FK__URLPATHPARTS_PATHPART_ID FOREIGN KEY (PATHPART_ID) REFERENCES documents.pathparts (ID);

ALTER TABLE documents.urlpathparts ADD CONSTRAINT FK__URLPATHPARTS_URLPATHPART_ID_NEXT FOREIGN KEY (URLPATHPART_ID_NEXT) REFERENCES documents.urlpathparts (ID);
...
ALTER TABLE documents.urlspathpart ADD CONSTRAINT FK__URLSPATHPART_PATHPART_ID FOREIGN KEY (PATHPART_ID) REFERENCES documents.pathparts (ID);

ALTER TABLE documents.urlspathpart ADD CONSTRAINT FK__URLSPATHPART_URL_ID FOREIGN KEY (URL_ID) REFERENCES documents.urls (ID);
...
ALTER TABLE queryserver.searchqueryresult ADD CONSTRAINT FK__SEARCHQUERYRESULT_SEARCHQUERY_ID FOREIGN KEY (SEARCHQUERY_ID) REFERENCES queryserver.searchquery (ID);

ALTER TABLE queryserver.searchqueryresult ADD CONSTRAINT FK__SEARCHQUERYRESULT_URL_ID FOREIGN KEY (URL_ID) REFERENCES documents.urls (ID);
