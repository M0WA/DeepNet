...
/* searchqueryresultinfo - Postgre   */
CREATE TABLE searchqueryresultinfo
(
 ID BIGSERIAL NOT NULL,
...
(
 ...
 download_speed NUMERIC(15) DEFAULT NULL,
 upload_speed NUMERIC(15) DEFAULT NULL,
 content_length NUMERIC(15) DEFAULT NULL,
 content_type VARCHAR(255) DEFAULT NULL,
 primary_ip NUMERIC(15) DEFAULT NULL,
...
/* searchqueryresult - Postgre   */
CREATE TABLE searchqueryresult
(
 ID BIGSERIAL NOT NULL,
 SEARCHQUERY_ID INTEGER NOT NULL,
 URL_ID INTEGER NOT NULL,
...
ALTER TABLE searchqueryresultinfo ADD CONSTRAINT FK__SEARCHQUERYRESULT_ID FOREIGN KEY (SEARCHQUERYRESULT_ID) REFERENCES searchqueryresult (ID);
...
ALTER TABLE searchqueryresult ADD CONSTRAINT FK__SEARCHQUERY_ID FOREIGN KEY (SEARCHQUERY_ID) REFERENCES searchquery (ID);

ALTER TABLE searchqueryresult ADD CONSTRAINT FK__URL_ID FOREIGN KEY (URL_ID) REFERENCES urls (ID);
