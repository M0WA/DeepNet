...
src/%.o: ../src/%.cpp
	...
	g++ -D_REENTRANT -I/usr/include/libxml2 -I../../Tools/src -I../../Logging/src -I../../Threading/src -O3 -fPIC -fomit-frame-pointer -g -Wall -c -fmessage-length=0 -pthread -rdynamic -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
