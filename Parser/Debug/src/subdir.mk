...
src/%.o: ../src/%.cpp
	...
	g++ -DENABLE_PERFORMANCE_LOG -DDEBUG_DEEPNET -D_REENTRANT -I/usr/include/libxml2 -I../../Tools/src -I../../Networking/src -I../../Threading/src -I../../Caching/src -I../../Bot/src -I../../Logging/src -I../../HtmlParser/src -I../../Database/src -I../../Database/generated -O0 -g3 -Wall -c -fmessage-length=0 -pthread -rdynamic -fPIC -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -o"$@" "$<"
