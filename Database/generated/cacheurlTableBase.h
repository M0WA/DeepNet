...
/**
 * @brief wrapper class for database table cacheurl
 */
class cacheurlTableBase : public TableBase {

private:
    cacheurlTableBase(const TableBase& base);

public:
    cacheurlTableBase();
    virtual ~cacheurlTableBase();

public:
    /**
     * factory function for cacheurl's table definition.
