...
const TableColumn* cachesecondleveldomainTableBase::GetColumn_ID() const {
...
const TableColumn* cachesecondleveldomainTableBase::GetColumn_size() const {
...
const TableColumn* cachesecondleveldomainTableBase::GetColumn_matches() const {
...
const TableColumn* cachesecondleveldomainTableBase::GetColumn_misses() const {
...
const TableColumn* cachesecondleveldomainTableBase::GetColumn_action_time() const {
