...
/**
 * @brief wrapper class for database table urlspathpart
 */
class urlspathpartTableBase : public TableBase {

private:
    urlspathpartTableBase(const TableBase& base);

public:
    urlspathpartTableBase();
    virtual ~urlspathpartTableBase();

public:
    /**
     * factory function for urlspathpart's table definition.
