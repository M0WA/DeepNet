...
/**
 * @brief wrapper class for database table searchqueryresult
 */
class searchqueryresultTableBase : public TableBase {

private:
    searchqueryresultTableBase(const TableBase& base);

public:
    searchqueryresultTableBase();
    virtual ~searchqueryresultTableBase();

public:
    /**
     * factory function for searchqueryresult's table definition.
