...
/**
 * @brief wrapper class for database table cachesubdomain
 */
class cachesubdomainTableBase : public TableBase {

private:
    cachesubdomainTableBase(const TableBase& base);

public:
    cachesubdomainTableBase();
    virtual ~cachesubdomainTableBase();

public:
    /**
     * factory function for cachesubdomain's table definition.
