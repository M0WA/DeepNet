...
const TableColumn* cachehtmlTableBase::GetConstColumn_ID() const {
...
TableColumn* cachehtmlTableBase::GetColumn_ID() {
...
const TableColumn* cachehtmlTableBase::GetConstColumn_size() const {
...
TableColumn* cachehtmlTableBase::GetColumn_size() {
...
const TableColumn* cachehtmlTableBase::GetConstColumn_matches() const {
...
TableColumn* cachehtmlTableBase::GetColumn_matches() {
...
const TableColumn* cachehtmlTableBase::GetConstColumn_misses() const {
...
TableColumn* cachehtmlTableBase::GetColumn_misses() {
...
const TableColumn* cachehtmlTableBase::GetConstColumn_action_time() const {
...
TableColumn* cachehtmlTableBase::GetColumn_action_time() {
...
void cachehtmlTableBase::GetBy_ID(
    ...
    TableDefinition* pTblDef(cachehtmlTableBase::CreateTableDefinition());
