...
const TableColumn* cachehtmlTableBase::GetColumn_ID() const {
...
const TableColumn* cachehtmlTableBase::GetColumn_size() const {
...
const TableColumn* cachehtmlTableBase::GetColumn_matches() const {
...
const TableColumn* cachehtmlTableBase::GetColumn_misses() const {
...
const TableColumn* cachehtmlTableBase::GetColumn_action_time() const {
