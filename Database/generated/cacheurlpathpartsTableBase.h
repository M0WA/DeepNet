...
/**
 * @brief wrapper class for database table cacheurlpathparts
 */
class cacheurlpathpartsTableBase : public TableBase {

private:
    cacheurlpathpartsTableBase(const TableBase& base);

public:
    cacheurlpathpartsTableBase();
    virtual ~cacheurlpathpartsTableBase();

public:
    /**
     * factory function for cacheurlpathparts's table definition.
