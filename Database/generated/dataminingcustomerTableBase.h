...
/**
 * @brief wrapper class for database table dataminingcustomer
 */
class dataminingcustomerTableBase : public TableBase {

private:
    dataminingcustomerTableBase(const TableBase& base);

public:
    dataminingcustomerTableBase();
    virtual ~dataminingcustomerTableBase();

public:
    /**
     * factory function for dataminingcustomer's table definition.
