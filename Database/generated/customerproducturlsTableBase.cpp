...
const TableColumn* customerproducturlsTableBase::GetConstColumn_ID() const {
...
TableColumn* customerproducturlsTableBase::GetColumn_ID() {
...
const TableColumn* customerproducturlsTableBase::GetConstColumn_PRODUCT_ID() const {
...
TableColumn* customerproducturlsTableBase::GetColumn_PRODUCT_ID() {
...
const TableColumn* customerproducturlsTableBase::GetConstColumn_URL_ID() const {
...
TableColumn* customerproducturlsTableBase::GetColumn_URL_ID() {
...
void customerproducturlsTableBase::GetBy_ID(
    ...
    TableDefinition* pTblDef(customerproducturlsTableBase::CreateTableDefinition());
