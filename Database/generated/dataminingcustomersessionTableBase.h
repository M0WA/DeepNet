...
/**
 * @brief wrapper class for database table dataminingcustomersession
 */
class dataminingcustomersessionTableBase : public TableBase {

private:
    dataminingcustomersessionTableBase(const TableBase& base);

public:
    dataminingcustomersessionTableBase();
    virtual ~dataminingcustomersessionTableBase();

public:
    /**
     * factory function for dataminingcustomersession's table definition.
