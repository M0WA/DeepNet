...
/**
 * @brief wrapper class for database table cachesecondleveldomain
 */
class cachesecondleveldomainTableBase : public TableBase {

private:
    cachesecondleveldomainTableBase(const TableBase& base);

public:
    cachesecondleveldomainTableBase();
    virtual ~cachesecondleveldomainTableBase();

public:
    /**
     * factory function for cachesecondleveldomain's table definition.
