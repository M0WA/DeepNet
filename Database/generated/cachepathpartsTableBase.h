...
/**
 * @brief wrapper class for database table cachepathparts
 */
class cachepathpartsTableBase : public TableBase {

private:
    cachepathpartsTableBase(const TableBase& base);

public:
    cachepathpartsTableBase();
    virtual ~cachepathpartsTableBase();

public:
    /**
     * factory function for cachepathparts's table definition.
