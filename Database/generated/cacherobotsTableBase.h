...
/**
 * @brief wrapper class for database table cacherobots
 */
class cacherobotsTableBase : public TableBase {

private:
    cacherobotsTableBase(const TableBase& base);

public:
    cacherobotsTableBase();
    virtual ~cacherobotsTableBase();

public:
    /**
     * factory function for cacherobots's table definition.
