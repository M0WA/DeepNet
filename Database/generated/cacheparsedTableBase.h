...
/**
 * @brief wrapper class for database table cacheparsed
 */
class cacheparsedTableBase : public TableBase {

private:
    cacheparsedTableBase(const TableBase& base);

public:
    cacheparsedTableBase();
    virtual ~cacheparsedTableBase();

public:
    /**
     * factory function for cacheparsed's table definition.
