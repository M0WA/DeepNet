...
/**
 * @brief wrapper class for database table docmeta
 */
class docmetaTableBase : public TableBase {

private:
    docmetaTableBase(const TableBase& base);

public:
    docmetaTableBase();
    virtual ~docmetaTableBase();

public:
    /**
     * factory function for docmeta's table definition.
