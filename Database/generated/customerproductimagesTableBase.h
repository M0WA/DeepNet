...
//
  ...
  /**
   * gets const column for imageUrl.
   * @return column for imageUrl.
   */
  const TableColumn* GetConstColumn_imageUrl() const;

  /**
   * gets column for imageUrl.
   * @return column for imageUrl.
   */
  TableColumn* GetColumn_imageUrl();
