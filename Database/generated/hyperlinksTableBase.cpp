...
const TableColumn* hyperlinksTableBase::GetConstColumn_ID() const {
...
TableColumn* hyperlinksTableBase::GetColumn_ID() {
...
const TableColumn* hyperlinksTableBase::GetConstColumn_TARGET_URL_ID() const {
...
TableColumn* hyperlinksTableBase::GetColumn_TARGET_URL_ID() {
...
const TableColumn* hyperlinksTableBase::GetConstColumn_URLSTAGE_ID() const {
...
TableColumn* hyperlinksTableBase::GetColumn_URLSTAGE_ID() {
...
const TableColumn* hyperlinksTableBase::GetConstColumn_count() const {
...
TableColumn* hyperlinksTableBase::GetColumn_count() {
