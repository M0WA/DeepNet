...
const TableColumn* dataminingcustomerTableBase::GetColumn_ID() const {
...
const TableColumn* dataminingcustomerTableBase::GetColumn_login() const {
...
const TableColumn* dataminingcustomerTableBase::GetColumn_password() const {
