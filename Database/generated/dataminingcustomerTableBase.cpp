...
const TableColumn* dataminingcustomerTableBase::GetConstColumn_ID() const {
...
TableColumn* dataminingcustomerTableBase::GetColumn_ID() {
...
const TableColumn* dataminingcustomerTableBase::GetConstColumn_login() const {
...
TableColumn* dataminingcustomerTableBase::GetColumn_login() {
...
const TableColumn* dataminingcustomerTableBase::GetConstColumn_password() const {
...
TableColumn* dataminingcustomerTableBase::GetColumn_password() {
