...
const TableColumn* cacherobotsTableBase::GetColumn_ID() const {
...
const TableColumn* cacherobotsTableBase::GetColumn_size() const {
...
const TableColumn* cacherobotsTableBase::GetColumn_matches() const {
...
const TableColumn* cacherobotsTableBase::GetColumn_misses() const {
...
const TableColumn* cacherobotsTableBase::GetColumn_action_time() const {
