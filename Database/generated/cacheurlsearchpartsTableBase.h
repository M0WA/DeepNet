...
/**
 * @brief wrapper class for database table cacheurlsearchparts
 */
class cacheurlsearchpartsTableBase : public TableBase {

private:
    cacheurlsearchpartsTableBase(const TableBase& base);

public:
    cacheurlsearchpartsTableBase();
    virtual ~cacheurlsearchpartsTableBase();

public:
    /**
     * factory function for cacheurlsearchparts's table definition.
