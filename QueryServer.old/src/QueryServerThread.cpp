...
QueryServerThread::QueryServerThread(const queryserver::QueryServerConfig& queryserverConfig, database::DatabaseConfig* databaseConfig, const std::string& requestXSD, const std::string responseXSD, threading::Mutex* acceptMutex, const int port, const int backlog)
...
QueryServerThread::QueryServerThread(const queryserver::QueryServerConfig& queryserverConfig, database::DatabaseConfig* databaseConfig, const std::string& requestXSD, const std::string responseXSD, threading::Mutex* acceptMutex, const std::string& filename, const int backlog)
...
fastcgiserver::FastCGIRequest* QueryServerThread::CreateRequest() {
	return dynamic_cast<fastcgiserver::FastCGIRequest*>(new QueryXmlRequest(this));
}
...
const queryserver::QueryServerConfig& QueryServerThread::GetQueryServerConfig() const {
