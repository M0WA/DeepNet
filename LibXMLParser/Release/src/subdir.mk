...
src/%.o: ../src/%.cpp
	...
	g++ -I/usr/include/libxml2 -I../../Caching/src -I../../Tools/src -I../../Threading/src -I../../HtmlParser/src -I../../Logging/src -I../../Networking/src -O3 -fPIC -fomit-frame-pointer -g -Wall -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -o "$@" "$<"
