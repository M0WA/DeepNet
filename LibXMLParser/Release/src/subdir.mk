...
src/%.o: ../src/%.cpp
	...
	g++ -I/usr/include/libxml2 -I../../Tools/src -I../../Threading/src -I../../HtmlParser/src -I../../Logging/src -I../../Networking/src -O3 -Wall -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
