...
src/%.o: ../src/%.cpp
	...
	g++ -D_REENTRANT -DDEBUG_DEEPNET -DENABLE_PERFORMANCE_LOG -I/usr/include/libxml2 -I../../Caching/src -I../../Tools/src -I../../Threading/src -I../../HtmlParser/src -I../../Logging/src -I../../Networking/src -O0 -g3 -Wall -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -o "$@" "$<"
