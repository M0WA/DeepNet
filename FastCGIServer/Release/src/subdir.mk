...
src/%.o: ../src/%.cpp
	...
	g++ -D_REENTRANT -I../../Logging/src -I../../Caching/src -I../../Tools/src -I../../Networking/src -I/usr/include/libxml2 -I../../HtmlParser/src -I../../Bot/src -I../../Database/src -I../../Database/generated -I../../Threading/src -O3 -fPIC -fomit-frame-pointer -g -Wall -c -fmessage-length=0  -rdynamic -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o"$@" "$<"
